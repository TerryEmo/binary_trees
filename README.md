...
Description
On this project we will be learning about the Details, Advantages,
and Disadvantages of use of trees as data structures. We also learn on how to
qualify a trees and to traverse them. 
On this project we will be implementing the following Binarys:
*Binary search, 
*AVL, 
*Max Binary Heap trees.
...
Authors
<details>
    <summary>TerryEmo</summary>
    <ul>
    <li><a href="https://github.com/TerryEmo">Github</a></li>
    </ul>
</details>
