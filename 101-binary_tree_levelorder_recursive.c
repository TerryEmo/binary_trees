...
/**
 * binary_tree_levelorder - Moves through a binary tree using level order traversal
...
/**
 * levels_rec - labels the function on all nodes on differnt level
 * @head: pointer to head of linked list with nodes at one level
 * @func: oointer to a function to call for each node
 */
void levels_rec(ll *head, void (*func)(int))
{
