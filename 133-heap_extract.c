 ...
 * @tree: pointer to the root node of the tree to calculae the height
 * Return: big or 0 if tree is NULL
 */
...
/**
 * _preorder - moves through a binary tree using existed traversal
...
/**
 * heap_extract - pull the root node from a max binary heap
