...
/**
 * inorder_successor - Restore the minimum value of a binary search tree
...
/**
 * bst_remove_recursive - Removes the node from a binary search of a tree recursively
 ...
 * replaced it with its first in order successor
 */
bst_t *bst_remove(bst_t *root, int value)
{
