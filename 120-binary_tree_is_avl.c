 ...
 * @tree: A pointer to the root node of the tree to calcilate the height
...
/**
 * is_avl_helper - Examine if a binary tree is a valid AVL tree
...
/**
 * binary_tree_is_avl - Examine if a binary tree is a valid AVL tree
 * @tree: A pointer to the root node of the tree to be examined
